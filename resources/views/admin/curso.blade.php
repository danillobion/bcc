...
<div class="container">
    ...
    @endif
    <form id="id_form_curso" method="post" enctype="multipart/form-data" action="{{ route('curso.admin.update') }}">
        @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            Deseja atualizar a seção Curso?
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-light" data-dismiss="modal">Não</button>
            <button type="button" class="btn btn-success" onclick="submit_curso()">Sim</button>
          </div>
        </div>
      </div>
  </div>
